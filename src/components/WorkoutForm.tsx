      ...
      <form className="flex flex-col" onSubmit={onSubmit}>
        ...
        <div className="mb-3 flex flex-col">
          ...
          <input
            ...
            {...register('load')}
          />
          <p className="mt-1 text-xs text-red-500">{errors.load?.message}</p>
        </div>
        ...
        <div className="mb-3 flex flex-col">
          ...
          <input
            ...
            {...register('reps')}
          />
          <p className="mt-1 text-xs text-red-500">{errors.reps?.message}</p>
        </div>

        <input
          className="mt-3 cursor-pointer rounded bg-emerald-500 py-1 text-white drop-shadow"
          type="submit"
        />
